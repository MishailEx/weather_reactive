...
public class WeatherService {
    ...
    public Mono<Weather> findByMaxTemperature() {
        return all().sort(Comparator.comparingInt(Weather::getTemperature)).last();
    }


    public Flux<Weather> filterMoreTemperature(Integer temp) {
        return all().filter(city -> city.getTemperature() > temp);
    }
}
